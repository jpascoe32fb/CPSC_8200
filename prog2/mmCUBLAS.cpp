...
extern void natrixNaive(const float* A, const float* B, float* C, int wA, int wB, dim3 threads, dim3 blocks);
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
int matrixMultiply_old(int argc, char **argv, int devID, sMatrixSize &matrix_size)
{
    cudaDeviceProp deviceProp;
...
////////////////////////////////////////////////////////////////////////////////
//! Run a simple test matrix multiply using Basic Cuda
////////////////////////////////////////////////////////////////////////////////
int matrixMultiply(int argc, char **argv, int devID, sMatrixSize &matrix_size)
{
    ...
    //perform warmup
    natrixNaive(d_A, d_B, d_C, matrix_size.uiWA, matrix_size.uiWB, threads, grid);
    cudaDeviceSynchronize(); 
    
    // create and start timer
    printf("Computing result using Basic Cuda...");
    ...
    // Verify the result (compare with CPU computation)
    // compute reference solution
    printf("Computing result using host CPU...");
    float *reference = (float *)malloc(mem_size_C);
    matrixMulCPU(reference, h_A, h_B, matrix_size.uiHA, matrix_size.uiWA, matrix_size.uiWB);
    ...
    printf("Comparing CUDA Kernel Matrix Multiply with CPU results: %s\n", (true == resCUDA) ? "PASS" : "FAIL");
